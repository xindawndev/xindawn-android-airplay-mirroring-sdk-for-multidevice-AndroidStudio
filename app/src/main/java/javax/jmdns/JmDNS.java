...
public abstract class JmDNS implements Closeable {
     ...
     * </p>
     * <p>
     * <b>Note:</b> This is a convenience method. The preferred constructor is {@link #create(java.net.InetAddress, String)}.<br/>
     ...
     * </p>
     *
     * @see #create(java.net.InetAddress, String)
     ...
     * {@link NetworkTopologyDiscovery.Factory#setClassDelegate(NetworkTopologyDiscovery.Factory.ClassDelegate)}. This must be done before creating a {@link javax.jmdns.JmDNS} or {@link JmmDNS} instance.
     * </p>
     *
     * @param addr
     *            IP address to bind to.
