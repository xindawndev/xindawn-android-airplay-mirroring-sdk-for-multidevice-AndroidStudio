...
0x64,0x00,0x1f,0xac,0x13,0x14,0x24,0x0f,0x01,0x17,0xee,0x6e,0x04,0x04,0x04,0x04,0x28,0xee,0x3c,0xb0

//0x64, 0x00, 0x28, 0xac, 0x56, 0x50, 0x2f, 0x02, 0xa7, 0xa9, 0xa6, 0xe0, 0x40, 0x40, 0x40, 0xDA, 0x08, 0x84, 0x65, 0x80,
...
//	bitbuf->buf = (uint8_t *)malloc(32);
//	memcpy(bitbuf->buf, sps_data, 32);
//	bitbuf->buf_size = 32;
//	bitbuf->bit_pos = 0;
...
//
//	int spsWidth = ((spsHandle.pic_width_in_mbs_minus1 + 1) * 16) - spsHandle.frame_crop_left_offset * 2 - spsHandle.frame_crop_right_offset * 2;
//	int	spsHeight = ((2 - spsHandle.frame_mbs_only_flag)* (spsHandle.pic_height_in_map_units_minus1 + 1) * 16) - (spsHandle.frame_crop_top_offset * 2) - (spsHandle.frame_crop_bottom_offset * 2);
//
//
//#else
//	PPS ppsHandle;
//	get_bit_context *ppsbitbuf = (get_bit_context *)malloc(sizeof(get_bit_context));
//	ppsbitbuf->buf = (uint8_t *)malloc(32);
//	memcpy(ppsbitbuf->buf, pps_data, 5);
//	ppsbitbuf->buf_size = 32;
//	ppsbitbuf->bit_pos = 0;
//	ppsbitbuf->cur_bit_pos = 0;
//
//	h264dec_picture_parameter_set((void *)ppsbitbuf, &ppsHandle);
//#endif
//
//
//}
